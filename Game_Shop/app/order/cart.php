...
if (is_post()) {
    ...
    if ($action == 'checkout' && $cart) {
        ...
        if ($total_price > 0) {
            ...
            clear_cart();
            temp('info', 'Checkout successful! Please complete your payment.');
            redirect("payment.php?id=$purchase_id");
        } else {
    ...
    <form method="post">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <button type="submit" name="remove" value="<?= $p->product_id ?>" formnovalidate>Remove</button>
                </td>
            </tr>
            <?php endforeach ?>
            <tr>
